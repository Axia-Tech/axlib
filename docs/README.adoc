...
You can use https://github.com/axia-tech/scripts/tree/master/dockerfiles/ci-linux[AXIA CI docker image] with all necessary dependencies to build Axlib:
...
docker run --rm -it -w /shellhere/axlib \
                    ...
                    axia-tech/ci-linux:production <cargo commands>
----
...
[source, shell]
----
git clone https://github.com/axia-tech/axlib.git
cd axlib
----
...
https://github.com/axia-tech/axlib/blob/master/core/primitives/src/crypto.rs#L767[here], but the
...
https://github.com/axia-tech/axlib/blob/master/LICENSE[LICENSE]
