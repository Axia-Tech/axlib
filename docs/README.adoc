...
cargo run --release \-- \
  ...
  --telemetry-url 'ws://127.0.0.1/submit/:1024 0' \
  --validator
...
If you are successful, you will see your node syncing a#/Flaming%20Fir
